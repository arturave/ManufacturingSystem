...
class EnhancedPartEditDialog(ctk.CTkToplevel):
    ...
    def setup_ui(self):
        ...
        # ILOŚĆ (qty) została przeniesiona do order_items - nie wyświetlamy w formularzu produktu!
        # Ilość będzie określana przy dodawaniu produktu do zamówienia
    ...
    def load_part_data(self):
        ...
        # qty zostało usunięte - ilość jest teraz w order_items, nie w produkcie
    ...
    def save_part(self):
        ...
        self.part_data = {
            ...
            # qty usunięte - ilość będzie określana przy dodawaniu do zamówienia w order_items
        ...
        if self.part_data_original and self.part_data_original.get('id'):
            ...
            try:
                updates = {
                    ...
                    'material_id': material_id,
                    'thickness_mm': thickness,
                    # qty usunięte - będzie w order_items
                    'bending_cost': bending_cost,
                    'additional_costs': additional_costs
                }
            ...
            try:
                new_part_data = {
                    ...
                    'material_id': material_id,
                    'thickness_mm': thickness,
                    # qty usunięte - ilość będzie określana w order_items przy dodawaniu do zamówienia
                    'bending_cost': bending_cost,
                    'additional_costs': additional_costs,
            ...
            try:
                ...
                if hasattr(self, 'customer_combo') and self.customer_combo.get():
                    ...
                    # Find customer ID by name using customer_map
